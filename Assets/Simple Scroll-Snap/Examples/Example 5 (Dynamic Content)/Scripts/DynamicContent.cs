...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    public class DynamicContent : MonoBehaviour
    {
        ...
        public void Add(int index, GameObject panelPref)
        {
            // Pagination
            ...
            // Panel
            scrollSnap.Add(panelPref, index);
        }
        ...
        //    Add(0);
        //}
        public void AddToBack(GameObject panelPref)
        {
            Add(scrollSnap.NumberOfPanels, panelPref);
        }
