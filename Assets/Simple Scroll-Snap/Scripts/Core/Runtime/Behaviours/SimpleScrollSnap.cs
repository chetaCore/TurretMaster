...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        // Events
        [SerializeField] public UnityEvent<GameObject, float> onTransitionEffects = new UnityEvent<GameObject, float>();
        [SerializeField] public UnityEvent<int> onPanelSelecting = new UnityEvent<int>();
        [SerializeField] public UnityEvent<int> onPanelSelected = new UnityEvent<int>();
        [SerializeField] public UnityEvent<int, int> onPanelCentering = new UnityEvent<int, int>();
